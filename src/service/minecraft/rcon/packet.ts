import { PacketType, PacketPayload, PacketRead } from "../../../types";
...
class Packet {
  ...
  public static payload: PacketPayload;
   ...
   */
  static write(id: number, type: number, payload: string): Buffer {
   ...
   */
  static read(packet: Buffer): PacketRead {
